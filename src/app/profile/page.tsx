...
export default function ProfilePage() {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      ...
      try {
        const res = await fetch("https://emailmarketingbackend.onrender.com/auth/profile", {
  ...
  const handleAvatarUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const res = await fetch("https://emailmarketingbackend.onrender.com/auth/upload-avatar", {
        method: "POST",
        headers: { Authorization: `Bearer ${token}` },
        body: formData,
      });
