...
export default function CampaignsPage() {
  ...
  const fetchCampaigns = async () => {
    try {
      setLoading(true);
      const res = await fetch("https://emailmarketingbackend.onrender.com/campaigns", {
  ...
  const handleSend = async (id: string) => {
    try {
      ...
      const res = await fetch(`https://emailmarketingbackend.onrender.com/campaigns/${id}/send`, {
        method: "POST",
        headers: getAuthHeaders(false),
      });
      if (!res.ok) {
